...
function Questions2() {
  ...
  const lista = [
    ...
    {
      palabra: 'one hundred thousand',
      solucion: '100000',
      funcion: addProperty6,
      background: error6 === 0 ? '' : 'inputBack',
    },
    {
      palabra: 'three hundred',
      solucion: '300',
        ...
        <Row className='mt-2'>
          <Col xs='12' className='text-center mb-1'>
            {!check ? (
              ...
              <div className='text-center mt-1'>
                <Link to='/questions3' className='btn btn-success'>
                  SEGUINTE PANTALLA
                </Link>
              </div>
            )}
          ...
          <Col xs='12'>
            {!check ? (
              ...
              <div>
                <img
                  src='https://media.giphy.com/media/cJcMPzXoDAsBa/giphy.gif'
                  alt='gif'
                  width='100%'
                  height='100%'
                ></img>
              ...
              <div>
                <img
                  src='https://media.giphy.com/media/lWZ77CqQbInm0/giphy.gif'
                  alt='gif'
                  width='100%'
                  height='100%'
                ></img>
