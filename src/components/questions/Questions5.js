        ...
        <Row className='mt-2'>
          <Col xs='12' className='text-center mb-1'>
            {!check ? (
              ...
              <div className='text-center mt-1'>
                <Link to='/screen56' className='btn btn-success'>
                  SEGUINTE PANTALLA
                </Link>
              </div>
            )}
          ...
          <Col xs='12'>
            {!check ? (
              ...
              <div>
                <img
                  src='https://media.giphy.com/media/3orieRw298XmtPdcf6/giphy.gif'
                  alt='gif'
                  width='100%'
                  height='100%'
                ></img>
              ...
              <div>
                <img
                  src='https://media.giphy.com/media/3o6Mb30ZqYK5sNv88o/giphy.gif'
                  alt='gif'
                  width='100%'
                  height='100%'
                ></img>
